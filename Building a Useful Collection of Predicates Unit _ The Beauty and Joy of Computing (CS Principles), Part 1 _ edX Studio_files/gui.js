...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem(
        ...
        function () {
            window.open(
                'https://snap.berkeley.edu/snapsource/snap.zip',
                'SnapSource'
            );
        }
    );
    ...
    menu.addItem(
        ...
        function () {
            ...
            var libMenu = new MenuMorph(this, 'Import library'),
                libUrl = 'https://snap.berkeley.edu/snapsource/libraries/' +
                    'LIBRARIES';

            function loadLib(name) {
                var url = 'https://snap.berkeley.edu/snapsource/libraries/'
                        + name
                        + '.xml';
...
IDE_Morph.prototype.getURLsbeOrRelative = function (url) {
    var request = new XMLHttpRequest(),
        myself = this;
    try {
        request.open('GET', 'https://snap.berkeley.edu/snapsource/' +
                                           url, false);
        request.send();
        if (request.status === 200) {
            return request.responseText;
    ...
    if (this.source === 'local') {
        ...
        this.listField.action = function (item) {
            ...
            src = myself.ide.getURL(
                'https://snap.berkeley.edu/snapsource/Examples/' +
                    item.name + '.xml'
            );
...
ProjectDialogMorph.prototype.getExamplesProjectList = function () {
    ...
    dir = this.ide.getURL('https://snap.berkeley.edu/snapsource/Examples/');
    dir.split('\n').forEach(
        function (line) {
