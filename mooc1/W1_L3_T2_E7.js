...
function AGTest(outputLog) {
    ...
    var correctNestedRepeats = function() {
        var largeTriangleRepeat = spriteContainsBlock(
            repeatSpec, 0, triangleRepeatInputs, true
        );
        if (largeTriangleRepeat) {
            var mediumTriangleRepeat = CBlockContainsInSprite(
                repeatSpec,
                repeatSpec,
                0,
                triangleRepeatInputs,
                triangleRepeatInputs,
                true
            )
            return mediumTriangleRepeat
        }
        return false;
    }
