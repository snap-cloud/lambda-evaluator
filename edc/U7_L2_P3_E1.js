...
function AGTest(outputLog) {
    ...
    var appendExists_1 = function() {
        return customBlockContains(blockName, "append %mult%l")
    }
    ...
    tip_1_1.newAssertTest(
        appendExists_1,
        'Testing if the "' + blockName + '" block calls the "append" block.',
        'The "' + blockName + '" block calls the "append" block within its function body.',
        'Make sure your "' + blockName + '" block calls the "append" block within its function body.',
        1
    );
